...
with open("../examples (older)/amazon2.csv") as datafile:
    ...
    for line in datafile:
        ...
        # if thisis the first occurence of this state
...
y_pos = list(range(len(data_by_state)))
...
ax.barh(y_pos,data_by_state.values())
plt.show()

# save the bar chart
fig.savefig('bar charts/amazon_hbar_chart.png', bbox_inches='tight')