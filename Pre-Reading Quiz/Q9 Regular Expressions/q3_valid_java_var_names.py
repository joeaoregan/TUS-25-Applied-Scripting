...
# a.
# var_name = "this-is-valid" # Not a valid variable name
# b.
# var_name = "is_this_valid?" # Not a valid variable name
# c.
var_name = "$is_this_valid" # Valid variable name
# d.
# var_name = "1_is_valid." # Not a valid variable name
