...
try:
    ...
    with open("exam_papers\\2024_25_winter\\q3_ape_index\\climbing.csv") as data_file:
        ...
        # Q3e
        ax[0].set_title("Scatter Plot Arm Span vs Height")
        ax[0].set_ylabel("Arm Span")
        ax[0].set_xlabel("Height")
        ax[0].scatter(x=height_list, y=armspans_list, s=5)

        ax[1].set_title("Box Plot of Ape Index")
        ax[1].set_ylabel("Ape Index")
        ax[1].boxplot(apeindex_list)

        ax[2].set_title("Histogram of Ages")
