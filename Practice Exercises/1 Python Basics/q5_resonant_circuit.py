# An LC circuit, also called a resonant circuit, consists of an inductor, represented by the letter L, 
...
# Write a program which inputs the values of the inductance and the capacitance and then calculates and displays the resonant frequency on an LC circuit correct to 3 decimal places.
